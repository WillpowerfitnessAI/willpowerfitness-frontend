    ...
    <main style={{minHeight:'100vh',background:'#0a0a0a',color:'#fff',
      ...
      <section style={{maxWidth:720,textAlign:'center'}}>
        ...
        <div style={{display:'flex',gap:'12px',justifyContent:'center',flexWrap:'wrap'}}>
          ...
          <a href={trialUrl}>
            <button style={{padding:'0.9rem 1.1rem',borderRadius:12,border:'1px solid #1f1f1f',background:'#1a1a1a',color:'#fff',cursor:'pointer'}}>
              Start Trial
            </button>
          </a>
          <a href={buyUrl}>
            <button style={{padding:'0.9rem 1.1rem',borderRadius:12,border:'1px solid #fff',background:'#fff',color:'#000',cursor:'pointer'}}>
              Join Now — $225/mo
            </button>
          </a>
        </div>
