  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
        {/* BIG logo, not rounded or tiny */}
        <div className="flex items-center gap-4">
          <Image
            src="/WYW-LOGO.png"     // <-- use your PNG from /public
        ...
        {/* Primary + secondary CTAs only */}
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <Link
              href="/subscribe"
              className="rounded-xl bg-teal-500 px-6 py-3 font-semibold text-neutral-900 hover:bg-teal-400 transition-colors"
            >
              Start Elite Access
            </Link>
            <Link
              href="/login"
              className="rounded-xl border border-white/15 px-6 py-3 hover:bg-white/10 transition-colors"
            >
              Log in
            </Link>
          </div>
